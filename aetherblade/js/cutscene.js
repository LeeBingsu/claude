    ...
    return {
      ...
      opening: {
        ...
        lines: [
          ...
          { t: 4.0, who: '', text: '왕국은 사흘 만에 사라졌고, 죽은 자들은 눕지 않았다.' },
          { t: 8.0, who: '', text: '살아남은 자들은 재의 야영지에 모여 마지막 불을 지켰다.' },
          { t: 12.6, who: '', text: '그리고 사흘 뒤 — 잿더미 속에서 한 사람이 눈을 떴다.' },
      ...
      ending: {
        ...
        lines: [
          ...
          { t: 7.0, who: '', text: '문은 닫혔다. 그러나 대륙에는 아직 세지 못한 상처가 남아 있었다.' },
