  ...
  const QUESTS = [
    {
      ...
      dialogue: [
        { who: '엘라라', text: '살아 있었구나. 사흘 만이야. 네 옆에 눕혀 뒀던 열둘은 아침에 전부 태웠다.' },
        { who: '엘라라', text: '설명은 나중에. 서쪽 평원이 문제다. 공허에 물든 늑대들이 물자 수레를 뜯었어. 사람까지 같이.' },
        { who: '리엔', text: '…손은 떨려도, 검은 아직 들려.' },
        { who: '엘라라', text: '그거면 됐다. 여섯 마리. 그 이상 남겨두면 오늘 밤 야영지 울타리를 넘는다. 깨끗하게 끝내.' },
      ],
      objectives: [{ type: 'kill', match: ['wolf', 'wolfAlpha'], count: 6, desc: '오염된 늑대 처치' }],
      rewards: { xp: 260, potion: 3 },
      complete: [
        { who: '엘라라', text: '피 냄새를 묻히고도 눈이 안 흔들리는군. 좋아 — 널 믿어도 되겠어.' },
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: '세라', text: '성채엔 허물들이 있어. 배가 갈린 채로도 창을 들고 서 있는 것들이야.' },
        { who: '엘라라', text: '유물만 챙겨 와. 싸움은 피할 수 있으면 피하고.' },
        { who: '세라', text: '…피할 수 있을 리가. 저것들은 숨소리까지 쫓아온다.' },
      ],
    ...
    },
    {
      ...
      dialogue: [
        { who: '엘라라', text: '유물을 옮기려면 성채가 조용해야 한다. 허물 여덟. 전부 치워줘.' },
        { who: '엘라라', text: '…저것들 목에 걸린 인식표, 내가 직접 채워준 것들이다. 목부터 끊어. 그게 제일 빠르다.' },
      ],
    ...
    },
    {
      ...
      dialogue: [
        ...
        { who: '엘라라', text: '봉인을 시작하면 저쪽도 알아챈다. 죽을 각오 말고, 죽일 각오를 해.' },
        { who: '카이', text: '즉, 두들겨 맞으면서 일하란 소리네. 하, 그래서 급료가 없는 건가.' },
      ],
    ...
    },
    {
      ...
      dialogue: [
        { who: '엘라라', text: '남쪽 원형장. 그 안에 있는 건… 내 스승이었던 것이다.' },
        { who: '엘라라', text: '균열을 처음 연 사람이고, 그걸 닫으려다 삼켜진 사람이야.' },
        { who: '세라', text: '그래서. 죽여도 되는 거야, 안 되는 거야. 애매하게 굴면 우리가 죽어.' },
        { who: '엘라라', text: '…끝내. 목을 치든 심장을 부수든. 그게 그 사람이 나한테 남긴 마지막 명령이니까.' },
      ],
